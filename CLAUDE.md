...
None currently known. All 471 iOS tests should pass on simulator.
...
Current version: **v1.9.0 — Per-group location controls & diagnostics** (feature, iOS). See ROADMAP.md for next steps.
